package fr.loicknuchel.typedapi

import cats.data.NonEmptyList
import fr.loicknuchel.typedapi.JsonUtils._
import fr.loicknuchel.typedapi.errors.OpenApiError.ErrorMessage
import fr.loicknuchel.typedapi.errors.{OpenApiError, OpenApiErrors}
import fr.loicknuchel.typedapi.models._
import fr.loicknuchel.typedapi.models.utils._
...
object OpenApiFactory {
  def parseJson(json: JsValue): Either[OpenApiErrors, OpenApi] = {
    ...
    json.validate[OpenApi].fold(
      errors => Left(OpenApiErrors(errors.map(e => formatError(e._1 -> e._2.toList)).toList)),
